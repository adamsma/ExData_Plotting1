...
plot4 <- function() {
	...
	png(file = "plot4.png", width = 504, height = 504, bg = "transparent", type = "cairo-png")
	...
	with(energyData, {
		...
		legend("topright", lty = 1, box.lty = 0, col = c("black", "red", "blue"), legend = colnames(energyData)[8:10])
