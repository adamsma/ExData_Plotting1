...
plot3 <- function() {
	...
	with(energyData, lines(timeStamp, Sub_metering_2, col = "red"))
	with(energyData, lines(timeStamp, Sub_metering_3, col = "blue"))
	legend("topright", lty = 1, col = c("black", "red", "blue"), legend = colnames(energyData)[8:10])
